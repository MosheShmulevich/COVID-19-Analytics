...
Patients_Details = load_workbook(filename='Database.xlsx', data_only=True)
...
class Statistic_Window(Tk):
    ...
    def ComboBox_Statistic(self):
        ...
        drop = OptionMenu(self, clicked, *options, command=self.selected)
        drop.pack(pady=20)

        myButton = Button(self, text="Enter a statistical analysis:\n", command=self.selected)
        myButton.pack()
